...
<div class="container-fluid col-12 d-none d-sm-none d-mb-none d-lg-block" style="height: 14vw;"></div>
                    ...
                    <div class="row">
                        <div class="col-12 m-2 col-md-8 col-lg-8">
                            <a href="https://www.linkedin.com/company/iridiumwaterproof/?originalSubdomain=dk"><img
                                        src="images/inHvid.webp" class="img m-3" alt="linkedin" style="width: 42px"></a>

                            <a href="https://www.youtube.com/@IWCSDenmark"><img
                                        src="images/youtube.webp" class="img m-3" alt="Youtube" style="width: 42px"></a>
                        </div>
                    </div>
                </div>
...
<footer class="container-fluid justify-content-center position-relative">
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-5 col-lg-5">
            ...
            <div class="row justify-content-center">
                <a href="mailto:info@iwcs.eu" class="block1 col-5 d-flex justify-content-end align-items-center"><img
                            src="images/home.png" alt="mail" style="width:60px;"></a>
